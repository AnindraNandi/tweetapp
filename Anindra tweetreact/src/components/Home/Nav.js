...
class Nav extends Component{
    ...
    constructor(props) {
      ...
      updateLogStatus=(event)=>{
        ...
        axios
          .post(`https://cors-everywhere.herokuapp.com/http://tweetapp-env.eba-au9yqf7p.ap-northeast-1.elasticbeanstalk.com/api/v1.0/tweets/logout?email=${this.state.email}`)
          .then((res) => {
