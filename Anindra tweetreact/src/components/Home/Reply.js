...
class Reply extends Component {
  ...
  replyHandler = (event) => {
    ...
    axios
      .post(
        `https://cors-everywhere.herokuapp.com/http://tweetapp-env.eba-au9yqf7p.ap-northeast-1.elasticbeanstalk.com/api/v1.0/tweets/${this.props.email}/reply3/${this.props.id}`,
        body
      )
      .then((res) => {
