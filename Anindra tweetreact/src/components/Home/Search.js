...
class Search extends Component{
    ...
    getTweetsByUser = (event) => {
        axios
          .get(`https://cors-everywhere.herokuapp.com/http://tweetapp-env.eba-au9yqf7p.ap-northeast-1.elasticbeanstalk.com/api/v1.0/tweets/${this.username.current.value}`)
          .then((res) => {
            this.dataArray=res.data;
            if(this.dataArray.length===0){
                this.setState({null:"No tweets found!",userTweets:[]});
            }
